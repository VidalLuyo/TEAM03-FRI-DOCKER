...
Reducción de capas: El Dockerfile fue estructurado de manera que se optimiza el número de capas, evitando copiar archivos innecesarios y limitando la cantidad de instrucciones COPY y RUN.
